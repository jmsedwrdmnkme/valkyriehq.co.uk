...
<header class="align-items-center container-fluid d-flex justify-content-between position-fixed py-3 top-0 z-2 bg-black bg-opacity-50">
  ...
  <div class="book mt-2 me-lg-0 mt-md-1 mt-lg-0">
